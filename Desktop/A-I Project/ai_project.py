...
class UIofProject(tk.Frame):
    master = ''
    variableText = "Please Enter text below ! and Press OK"
    ...
    def __init__(self, master=None):
        ...
        okButton = tk.Button(bottomFrame, text="OK", command=self.applySentimentAnalyzer, height=1, width=10, bg="green")
        partThird = tk.Button(topFrame, text="Tricky \nSentence \nExamples", command=self.sentimentPartThird, height=3, width=10, bg="green")
        quitButton = tk.Button(topFrame, text="Exit", height=1, width=10, bg="RED", command=quit)

        self.userInput = tk.Entry(bottomFrame, width=50)
        self.responseConsole.insert(tk.END, self.variableText)

        self.lableText = tk.Label(bottomFrame, text="Enter Text:")


        self.responseConsole.pack(side='left')
        demoButton.pack(side='top')
        nltkButton.pack(side='top')
        partThird.pack(side='top')
        quitButton.pack(side='top')
        self.lableText.pack(side='left');
    ...
    def applySentimentAnalyzer(self):
        #sentences = [input("Enter a String to apply Sentiment Analysis: ")]
        sentences = [self.userInput.get()]
        ...
        for sentence in sentences:
            ...
            self.responseConsole.delete('1.0', tk.END)
            self.responseConsole.insert(tk.END, "\n{} \n {}".format(sentence, str(vs)))


    def sentimentDemo(self):
        sentences = ["luckiest",
                     "he is good",
                     "he is GOOD",
    ...
    def nltk(self):
        ...
        self.responseConsole.insert(tk.END, "  -- For example, given the following paragraph text from a hypothetical movie review:\n\t'{}'".format(
                paragraph))
        ...
        self.responseConsole.insert(tk.END, "AVERAGE SENTIMENT FOR PARAGRAPH: \t" + str(round(paragraphSentiments / len(sentence_list), 4)))
